        ...
        _gsScope._gsDefine("TweenMax", ["core.Animation", "core.SimpleTimeline", "TweenLite"], function(t, e, i) {
            ...
            function() {
                ...
                var l, _, u, p, c, f, m = /(?:\d|\-\d|\.\d|\-\.\d)+/g,
                    ...
                    I = {},
                    E = document,
                    F = (E.documentElement, E.createElement("div")),
                ...
                var le = function(t, e, i, s) {
                    ...
                    ce = a.parseComplex = function(t, e, i, s, r, n, a, o, h, _) {
                        ...
                        for ((-1 !== s.indexOf(",") || -1 !== i.indexOf(",")) && (k = k.join(" ").replace(D, ", ").split(" "), R = R.join(" ").replace(D, ", ").split(" "), A = k.length), A !== R.length && (k = (n || "").split(" "), A = k.length), a.plugin = h, a.setRatio = _, u = 0; A > u; u++)
                            if (f = k[u], g = R[u], T = parseFloat(f), T || 0 === T) a.appendXtra("", T, ie(g, T), g.replace(d, ""), O && -1 !== g.indexOf("px"), !0);
                ...
                var ve = "scaleX,scaleY,scaleZ,x,y,z,skewX,skewY,rotation,rotationX,rotationY,perspective,xPercent,yPercent".split(","),
                    ...
                    Se = Pe && (f || /Android/i.test(X) && !window.chrome),
                    ke = function(t, e, i) {
                        var s = t.getBBox();
                    ...
                    Re = N.getTransform = function(t, e, i, s) {
                        ...
                        var n, o, h, l, _, u, p, c, f, m, d, g, v, y = i ? t._gsTransform || new be : new be,
                            T = 0 > y.scaleX,
                            w = 2e-5,
                            x = 1e5,
                            b = 179.99,
                            P = b * M,
                            S = xe ? parseFloat(W(t, we, e, !1, "0 0 0").split(" ")[2]) || y.zOrigin || 0 : 0,
                ...
                de("transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent", {
                    parser: function(t, e, i, s, n, o, h) {
                        ...
                        var l, _, u, p, c, f, m, d = s._transform = Re(t, r, !0, h.parseTransform),
                            g = t.style,
                            v = 1e-6,
                            y = ve.length,
                            T = h,
                            w = {};
                        if ("string" == typeof T.transform && ye) u = F.style, u[ye] = T.transform, u.display = "block", u.position = "absolute", E.body.appendChild(F), l = Re(F, null, !1), E.body.removeChild(F);
                ...
                var Ie = function(t) {
                    if ((1 === t || 0 === t) && this.data._totalTime === this.data._totalDuration && "isFromStart" !== this.data.data) {
                        ...
                        if ("all" === this.e) n.cssText = "", r = !0;
                            ...
                            for (e = this.e.split(" ").join("").split(","), s = e.length; --s > -1;) i = e[s], o[i] && (o[i].parse === a ? r = !0 : i = "transformOrigin" === i ? we : o[i].p), Me(n, i);
                ...
                var Fe = function(t, e, i) {
                    ...
                    if (t.slice)
                        ...
                        for (s = t.childNodes, r = s.length; --r > -1;) n = s[r], a = n.type, n.style && (e.push($(n)), i && i.push(n)), 1 !== a && 9 !== a && 11 !== a || !n.childNodes.length || Fe(n, e, i)
                };
                return a.cascadeTo = function(t, i, s) {
                    ...
                    for (t = o._targets || o.target, Fe(t, l, u), o.render(i, !0), Fe(t, _), o.render(0, !0), o._enabled(!0), r = u.length; --r > -1;)
                ...
                W = function(t, e, i, s, r) {
                    ...
                    if (1 === s || s >= 4) {
                        for (h = r.length, n = 0; h > n; n++)
                            if ((o = r[n]) !== e) o._gc || (o._enabled(!1, !1) && (a = !0), G(o, e));
                            else if (5 === s) break;
                        return a
                    }
