    ...
    var o = function() {
        ...
        f = function() {
            ...
            return n.destroy = function() {
                ...
                if (t) {
                    var s = this._one;
                    if (this._cmds) {
                        for (n = this._cmds.length, i = 0; i < n; i++) !(s = this._cmds[i]) || s.callee !== R._context._drawTexture && s.callee !== R._context._drawTextureWithTransform || (s[0] = null, e._cache.push(s));
                        this._cmds.length = 0
                ...
                if (void 0 === i && (i = 0), void 0 === n && (n = 0), void 0 === s && (s = 0), void 0 === r && (r = 0), void 0 === a && (a = 1), !t || a < .01) return null;
        ...
        p = function() {
            ...
            return e.destroy = function() {
                ...
                for (var a, h, l = t._tempMatrix, u = NaN, c = NaN, _ = NaN, d = NaN, f = NaN, p = NaN, g = 0, m = s.length; g < m; g++)
                    if ((a = s[g]).callee) switch (a.callee) {
                        case n._save:
                        case 7:
                            r.push(o), o = o.clone();
                            break;
                    ...
                    for (var i, n = 0, s = 0, r = 0; n < e;) {
                        ...
                        switch ("mousemove" !== o.type && (this._prePoint.x = this._prePoint.y = -1e6), o.type) {
                            ...
                            case "touchstart":
                                ...
                                for (s = 0, r = a.length; s < r; s++) i = a[s], (t.multiTouchEnabled || isNaN(this._curTouchID)) && (this._curTouchID = i.identifier, this._id % 200 == 0 && (this._touchIDs = {}), this._touchIDs[i.identifier] = this._id++, this.initEvent(i, o), this.check(this._stage, this.mouseX, this.mouseY, this.onMouseDown));
                                break;
                            case "touchend":
                            case "touchcancel":
                                t._isTouchRespond = !0, this._isLeftMouse = !0;
                            ...
                            case "touchmove":
                                ...
                                for (s = 0, r = l.length; s < r; s++) i = l[s], (t.multiTouchEnabled || i.identifier == this._curTouchID) && (this.initEvent(i, o), this.check(this._stage, this.mouseX, this.mouseY, this.onMouseMove));
                                break;
                            case "wheel":
                            case "mousewheel":
                            case "DOMMouseScroll":
                ...
                if (void 0 === n && (n = !1), this.enable) {
                    ...
                    if (_ = n ? this.preDowns : this.preRightDowns, s = this.getTouchFromArr(i, _)) {
                        ...
                        if (d = f - this._lastClickTime < 300, this._lastClickTime = f, e == s.tar) h = r;
                            ...
                            for (o = this.getEles(s.tar, null, t._oldArr), (h = t._newArr).length = 0, u = o.length, l = 0; l < u; l++) a = o[l], r.indexOf(a) >= 0 && h.push(a);
        ...
        b = function() {
            ...
            return s(t, "laya.maths.GrahamScan"), t.multiply = function(t, e, i) {
                ...
                var i, n, s, r = 0,
                    ...
                    h = e.length,
                    l = {};
                for ((n = t._temArr).length = 0, r = (h = e.length) - 1; r >= 0; r--) s = (i = e[r]).x + "_" + i.y, l.hasOwnProperty(s) || (l[s] = !0, n.push(i));
                for (h = n.length, K.copyArray(e, n), r = 1; r < h; r++)(e[r].y < e[a].y || e[r].y == e[a].y && e[r].x < e[a].x) && (a = r);
        ...
        P = function() {
            ...
            return e.setTo = function(t, e, i, n) {
                ...
                var n, s, r, o, a, h = e.length,
                    l = S.TEMP;
                for (r = a = -(s = o = 99999), n = 0; n < h; n += 2) l.x = e[n], l.y = e[n + 1], s = s < l.x ? s : l.x, o = o < l.y ? o : l.y, r = r > l.x ? r : l.x, a = a > l.y ? a : l.y;
            ...
            return e.onCreate = function(t) {}, e._style = function(t, e, i, n) {
                ...
                if (r) {
                    ...
                    if ("bitmap" === d ? $.canvasBitmap++ : $.canvasNormal++, _) {
                        ...
                        if (f = u.width * g, p = u.height * m, h = u.x, l = u.y, R.isWebGL && "bitmap" === d && (f > 2048 || p > 2048)) return console.warn("cache bitmap size larger than 2048,cache ignored"), r.ctx && (X.recover("RenderContext", r.ctx), r.ctx.canvas.size(0, 0), r.ctx = null), void o._fun.call(o, t, e, n, s);
                        ...
                        } else b = c.ctx, !R.isConchWebGL && R.isConchApp && (T = t._$P.cf) && b.setFilterMatrix && b.setFilterMatrix(T._mat, T._alpha), o._fun.call(o, t, c, -h, -l), R.isConchApp && !R.isConchWebGL || t._applyFilters();
                        t._$P.staticCache && (r.reCache = !1), $.canvasReCache++
                    } else h = (u = r._cacheRec).x, l = u.y, a = c.canvas;
            ...
            return e.___resizeBuffer = function(t) {
                ...
                for (var e = "", i = 0, n = 0, s = String.fromCharCode, r = this._u8d_; t > 0;)
                    if ((n = r[this._pos_]) < 128) e += s(n), this._pos_++, t--;
                        ...
                        for (i = n - 128, this._pos_++, t -= i; i > 0;) n = r[this._pos_++], e += s(r[this._pos_++] << 8 | n), i--;
                return e
            }, e.clear = function() {
            ...
            return s(t, "laya.utils.CacheManager"), t.regCacheByFunction = function(e, i) {
                ...
                if (!(e.length < 1)) {
                    var i = N.now(),
                        n = 0,
                        s = 0;
                    for (s = n = e.length; n > 0 && (t._index++, t._index = t._index % s, e[t._index].tryDispose(!1), !(N.now() - i > t.loopTimeLimit));) n--
                }
        ...
        j = function() {
            ...
            return e.to = function(t, e, i, n, s, r, o) {
                ...
                if (this.pause(), this._usedTimer = 0, this._startTimer = N.now(), this._delayParam) i.scaleTimer.once(this._delay, this, this.firstStart, this._delayParam);
                else {
        ...
        et = function(t) {
            ...
            return i.dispose = function() {
                ...
                var r;
                if (t == E._tMusic ? (e._initMusicAudio(), (r = e._musicAudio).src != t && (e._audioCache[r.src] = null, r = null)) : r = e._audioCache[t], r && r.readyState >= 2) this.event("complete");
                else {
                ...
                var n;
                if (!(n = this.url == E._tMusic ? e._musicAudio : e._audioCache[this.url])) return null;
                var s;
        ...
        st = function(t) {
            ...
            return i.load = function(t) {
                var i = this;
                if (t = L.formatURL(t), this.url = t, this.audioBuffer = e._dataCache[t], this.audioBuffer) this._loaded(this.audioBuffer);
        ...
        ot = function(t) {
            ...
            return n.load = function(t, i, n, s, r) {
                if (void 0 === n && (n = !0), void 0 === r && (r = !1), this._url = t, 0 === t.indexOf("data:image") ? this._type = i = "image" : (this._type = i || (i = this.getTypeFromUrl(t)), t = L.formatURL(t)), this._cache = n, this._data = null, !r && e.loadedMap[t]) return this._data = e.loadedMap[t], this.event("progress", 1), void this.event("complete", this._data);
                ...
                if ("plf" == i) this.parsePLFData(t), this.complete(t);
                    ...
                    if (!t.src && !t._setContext) {
                        if (!this._data) {
                            if (this._data = t, t.meta && t.meta.image)
                                for (var s = t.meta.image.split(","), r = this._url.indexOf("/") >= 0 ? "/" : "\\", o = this._url.lastIndexOf(r), a = o >= 0 ? this._url.substr(0, o + 1) : "", h = 0, l = s.length; h < l; h++) s[h] = a + s[h];
                    ...
                    if (this._data.meta && this._data.meta.scale && 1 != this._data.meta.scale) {
                        ...
                        for (v in c) w = f[(y = c[v]).frame.idx ? y.frame.idx : 0], x = L.formatURL(d + v), e.cacheRes(x, lt.create(w, y.frame.x, y.frame.y, y.frame.w, y.frame.h, y.spriteSourceSize.x, y.spriteSourceSize.y, y.sourceSize.w, y.sourceSize.h)), e.loadedMap[x].url = x, g.push(x);
                ...
                for (i in t) switch (s = t[i], i) {
                    case "json":
                    case "text":
                        for (n in s) e.preLoadedMap[L.formatURL(n)] = s[n];
                        break;
                    default:
                        for (n in s) e.preLoadedMap[L.formatURL(n)] = s[n]
                }
        ...
        at = function(t) {
            ...
            return o.create = function(t, e, i, n, s, r, o, a) {
                ...
                if (null == n) {
                    ...
                    if (r < this.retryNum) return console.warn("[warn]Retry to load:", s), this._failRes[s] = r + 1, void i.timer.once(this.retryDelay, this, this._addReTry, [t], !1);
        ...
        ht = (function(t) {
            ...
            return i.imps(n, {
                ...
                if (t) {
                    ...
                    if (n)
                        for (var s = n.slice(), r = 0, o = s.length; r < o; r++)(i = s[r]).lock || 0 !== i._referenceCount || i.destroy()
                } else
        ...
        ct = function(e) {
            ...
            return i.imps(h, {
                ...
                for (var n, s, r, o = this._graphics ? this._graphics.getBoundPoints() : K.clearArray(this._$P.temBM), a = 0, h = (r = this._childs).length; a < h; a++)(n = r[a]) instanceof laya.display.Sprite && 1 == n.visible && (s = n._boundPointsToParent(t)) && (o = o ? K.concatArray(o, s) : s);
                return o
            }, h.getStyle = function() {
                ...
                if (t !== (e ? e.type : "none")) {
                    if ("none" !== t) this._getBit(1) || this._setUpNoticeType(1), e || (e = this._set$P("cacheCanvas", X.getItemByClass("cacheCanvas", Object))), e.type = t, e.reCache = !0, this._renderType |= 16, "bitmap" == t && this.conchModel && this.conchModel.cacheAs(1), this._set$P("cacheForFilters", !1);
        ...
        wt = (function(t) {
            ...
            n.destroy = function(t) {
                ...
                if ("string" == typeof t) {
                    var h = ot.getAtlas(t);
                    if (h && h.length)
                        for (n = [], r = 0, a = h.length; r < a; r++)(s = new o.createGraphics).drawTexture(ot.getRes(h[r]), 0, 0), n.push(s)
                } else if (t instanceof Array)
                    for (n = [], r = 0, a = t.length; r < a; r++)(s = new o.createGraphics).loadImage(t[r], 0, 0), n.push(s);
            ...
            return i._setUp = function(t, e) {
                ...
                if (o > this._count && (this._count = o), t.tween)
                    for (null == (n = Y[t.tweenMethod]) && (n = Y.linearNone), s = r; s < o; s++) i[s] = n(s - r, a, h, l), this._animationNewFrames && (this._animationNewFrames[s] = !0);
                else
                    for (s = r; s < o; s++) i[s] = a;
        ...
        bt = (function(t) {
            ...
            i._onOtherBegin = function(t) {
                ...
                if (this._target) {
                    ...
                    a = t.secondFrames;
                    var _, d, f, p, g = 0;
                    for (u = 0; u < c; u++) r = h[s = l[u]], -1 == (g = a[s]) ? o = this._initData[s] : e < g ? (f = (d = t.keyframes[s])[0]).tween ? (null == (_ = Y[f.tweenMethod]) && (_ = Y.linearNone), p = d[1], o = _(e, this._initData[s], p.value - this._initData[s], p.index)) : o = this._initData[s] : o = r.length > e ? r[e] : r[r.length - 1], n[s] = o
                }
            ...
            return r._parseNodeList = function(t) {
                ...
                if (!(o < .01)) {
                    ...
                    if (l = t.child) {
                        var u = 0,
                            c = 0;
                        for (c = l.length, u = 0; u < c; u++) this._updateNodeGraphic(l[u], e, a, n, o)
                    }
                }
